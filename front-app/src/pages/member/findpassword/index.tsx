...
const FindPasswordPage = () => {
  ...
  const findPassword = () => {
    // logic
    void router.push("/member/findpassword/result")
  }
  return (
    <LayoutLogin>
      <div>
        <div className={styles.container}>
          ...
          <ul className={styles.page_info_list}>
            <li className={styles.page_info_list_item}>
              회원님의 비밀번호를 초기화 후 신규로 발급한 비밀번호를 알려드립니다.
            </li>
            <li className={styles.page_info_list_item}>
              발급된 비밀번호로 로그인 후 내 정보 {">"} 비밀번호 변경 메뉴에서 수정하실 수 있습니다.
            </li>
        ...
        <div className={styles.submit_box}>
          <button className={styles.submit_button} onClick={findPassword}>
            찾기
          </button>
        </div>
      </div>
