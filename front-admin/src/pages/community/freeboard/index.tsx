...
const CommunityFreeboardManagementPage = () => {
  ...
  useAsyncEffect(async () => {
    const response = await apiManager.communityApi.getList({
      ...
      page: page,
      row: 20,
      type: COMMUNITY_BOARD_TYPE.FREE,
  ...
  return (
    <LayoutMain>
      ...
      <Col className={styles.container}>
        <Row className={styles.page_title}>자유 게시판</Row>
...
export default AuthHoc(CommunityFreeboardManagementPage)
