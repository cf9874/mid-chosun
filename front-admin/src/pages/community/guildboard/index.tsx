...
const CommunityGuildManagementPage = () => {
  ...
  useAsyncEffect(async () => {
    const response = await apiManager.communityApi.getList({
      ...
      page: page,
      row: 20,
      type: COMMUNITY_BOARD_TYPE.MUNPA,
  ...
  return (
    <LayoutMain>
      ...
      <Col className={styles.container}>
        <Row className={styles.page_title}>문파홍보 게시판</Row>
...
export default AuthHoc(CommunityGuildManagementPage)
