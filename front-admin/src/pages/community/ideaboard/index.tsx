...
const CommunityIdeaboardManagementPage = () => {
  ...
  useAsyncEffect(async () => {
    const response = await apiManager.communityApi.getList({
      ...
      page: page,
      row: 20,
      type: COMMUNITY_BOARD_TYPE.IDEA,
  ...
  return (
    <LayoutMain>
      ...
      <Col className={styles.container}>
        <Row className={styles.page_title}>아이디어 게시판</Row>
...
export default AuthHoc(CommunityIdeaboardManagementPage)
